...
class TestSummary(TestCase):
    ...
    def test_calculate_weighted_word_frequencies(self):
        ...
        expected_weighted_word_frequencies = dict(
            Alpha=0.25, Beta=0.5, Charlie=0.75, Delta=1
        )
        actual_weighted_word_frequencies = (
            summary._calculate_weighted_word_frequencies()
        )
        self.assertEqual(
            expected_weighted_word_frequencies, actual_weighted_word_frequencies
        )
    ...
    def test_calculate_sentence_scores(self):
        ...
        summary = Summary(text)
        expected_sentence_scores = defaultdict(
            int,
            {
        ...
        actual_sentence_scores = summary._calculate_sentence_scores(
